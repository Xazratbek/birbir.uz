    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['listing', 'created_at'], name='lview_listing_created_idx'), models.Index(fields=['user', 'created_at'], name='lview_user_created_idx'), models.Index(fields=['session_key', 'created_at'], name='lview_session_created_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='listing',
